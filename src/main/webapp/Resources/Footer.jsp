...
<div id="footer" class=" px-0 mt-3">
	...
	<div id = "footer-content" class="row align-items-end px-5 py-3">
		<div class="col-4">
			...
			<a href="https://substack.com/home-i">
				<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-substack" viewBox="0 0 16 16">
			...
			<b>&copy; 2025 PlaceEat. All rights reserved</b><br>	
		</div>
		<div class="col-5">
			<h4>여행지 & 맛집 추천 커뮤니티!</h4>
			회사명: PLACE-EAT <br>
			사업자 등록번호: 123-45-67890<br>
			대표자명: 홍길동<br>
			서울시 관악구 남부순환로 1820, 에그 옐로우<br>	
		</div>
		<div class="col-3">
			<br>
